...
namespace ya
{
	...
	void RamonaScript::Initialize()
	{
		...
		at->Create(L"IdleRight", atlas, enums::eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(151.0f / 5.0f, 65.0f), 5);

		atlas
			= Resources::Load<Texture>(L"Idle", L"..\\Resources\\Texture\\Idle.png");
		at = this->GetOwner()->GetComponent<Animator>();
		at->Create(L"IdleLeft", atlas, enums::eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(151.0f / 5.0f, 65.0f), 5);
		...
		at->CompleteEvent(L"Jump") = std::bind(&RamonaScript::Complete, this);
